...
class MeetergoIntegration {
    ...
    init() {
        ...
        if (((_a = window.meetergoSettings) === null || _a === void 0 ? void 0 : _a.videoEmbed) &&
    ...
    onFormSubmit(e) {
        ...
        if (!target)
            return;
        const targetListener = (_a = window.meetergoSettings) === null || _a === void 0 ? void 0 : _a.formListeners.find((listener) => {
            // Need to define `id`
            if (!target.id)
                return false;
    ...
    addSidebar() {
        var _a, _b, _c, _d;
        if (((_a = window.meetergoSettings) === null || _a === void 0 ? void 0 : _a.sidebar) &&
            ((_b = window.meetergoSettings) === null || _b === void 0 ? void 0 : _b.sidebar.link)) {
            ...
            const buttonText = window.meetergoSettings.sidebar.buttonText || "Open Scheduler";
            const buttonIcon = window.meetergoSettings.sidebar.buttonIcon || "calendar";
            const buttonPosition = window.meetergoSettings.sidebar.buttonPosition || "middle-right";
            ...
            toggleButton.classList.add("meetergo-sidebar-toggle", position === "left"
                ? "meetergo-sidebar-toggle-left"
                : "meetergo-sidebar-toggle-right");
            ...
            if ((_c = window.meetergoSettings) === null || _c === void 0 ? void 0 : _c.sidebar.backgroundColor) {
                toggleButton.style.backgroundColor =
                    window.meetergoSettings.sidebar.backgroundColor;
            }
            if ((_d = window.meetergoSettings) === null || _d === void 0 ? void 0 : _d.sidebar.textColor) {
    ...
    addFloatingButton() {
        ...
        if (((_a = window.meetergoSettings) === null || _a === void 0 ? void 0 : _a.floatingButton) &&
            ((_c = (_b = window.meetergoSettings) === null || _b === void 0 ? void 0 : _b.floatingButton) === null || _c === void 0 ? void 0 : _c.position) &&
            ((_d = window.meetergoSettings) === null || _d === void 0 ? void 0 : _d.floatingButton.link)) {
            const position = (_e = window.meetergoSettings) === null || _e === void 0 ? void 0 : _e.floatingButton.position;
            const animation = ((_f = window.meetergoSettings) === null || _f === void 0 ? void 0 : _f.floatingButton.animation) || "none";
            let button = document.createElement("button");
            button.classList.add("meetergo-modal-button");
            const buttonText = (_j = (_h = (_g = window.meetergoSettings) === null || _g === void 0 ? void 0 : _g.floatingButton) === null || _h === void 0 ? void 0 : _h.text) !== null && _j !== void 0 ? _j : "Book appointment";
            if ((_l = (_k = window.meetergoSettings) === null || _k === void 0 ? void 0 : _k.floatingButton) === null || _l === void 0 ? void 0 : _l.icon) {
                this.loadLucideIcon(window.meetergoSettings.floatingButton.icon, button, buttonText);
            }
            else {
            ...
            if ((_m = window.meetergoSettings) === null || _m === void 0 ? void 0 : _m.floatingButton.backgroundColor)
                button.style.backgroundColor =
                    (_o = window.meetergoSettings) === null || _o === void 0 ? void 0 : _o.floatingButton.backgroundColor;
            if ((_p = window.meetergoSettings) === null || _p === void 0 ? void 0 : _p.floatingButton.textColor)
                button.style.color = (_q = window.meetergoSettings) === null || _q === void 0 ? void 0 : _q.floatingButton.textColor;
            if (animation !== "none") {
                if (animation === "pulse") {
    ...
    getParamsFromMainIframe() {
        const iframeParams = {};
        const divIframe = document.querySelector(".meetergo-iframe");
        if (divIframe) {
    ...
    openModalWithContent(settings) {
        var _a;
        try {
            if ((_a = window.meetergoSettings) === null || _a === void 0 ? void 0 : _a.disableModal) {
                return;
            }
    ...
    bindElementToScheduler(element, schedulerLink, options) {
        try {
            ...
            const clickHandler = (e) => {
                ...
                if (!link) {
                    console.error("meetergo: No scheduler link provided for bound element");
                    return;
                }
                this.openModalWithContent({
                    link,
    ...
    launchScheduler(schedulerLink, params) {
        ...
        try {
            ...
            console.error("meetergo: Error launching scheduler programmatically", error);
        }
    }
    openModal() {
        try {
    ...
    closeModal(preventClearContent) {
        try {
            const modal = document.getElementById("meetergo-modal");
            if (!modal) {
                console.error("meetergo: Modal element not found when attempting to close");
                return;
            }
            modal.style.visibility = "hidden";
            modal.style.opacity = "0";
        ...
        try {
            ...
            Array.from(anchors).forEach((anchor) => {
                ...
                try {
                    ...
                    console.error("meetergo: Error processing iframe element", innerError);
                }
            });
        }
        catch (error) {
    ...
    postScrollHeightToParent(scrollHeight) {
    ...
    getPrifillParams(existingParams) {
        ...
        try {
            ...
            if ((_a = window.meetergoSettings) === null || _a === void 0 ? void 0 : _a.prefill) {
                prefill = Object.assign(Object.assign({}, prefill), window.meetergoSettings.prefill);
            }
            if (existingParams) {
    ...
    setPrefill(prefill) {
        try {
            ...
            window.meetergoSettings.prefill = Object.assign({}, prefill);
            const modal = document.getElementById("meetergo-modal");
    ...
    initVideoEmbed() {
        var _a;
        try {
            const settings = (_a = window.meetergoSettings) === null || _a === void 0 ? void 0 : _a.videoEmbed;
            if (!(settings === null || settings === void 0 ? void 0 : settings.videoSrc) || !(settings === null || settings === void 0 ? void 0 : settings.bookingLink)) {
     ...
     */
    createVideoEmbed(settings) {
        if (!(settings === null || settings === void 0 ? void 0 : settings.videoSrc) || !(settings === null || settings === void 0 ? void 0 : settings.bookingLink))
            return;
        // Extract settings with defaults
        const { videoSrc, bookingLink, posterImage = "", position = "bottom-right", buttonColor = "#0a64bc", bookingCta = "Book Appointment", size = { width: "200px", height: "158px" }, isRound = false, offset = "16px", // Added offset with default value
         } = settings;
        ...
        // Set size and shape
        if (isRound) {
            const diameter = Math.min(parseInt((size === null || size === void 0 ? void 0 : size.width) || "200"), parseInt((size === null || size === void 0 ? void 0 : size.height) || "158")) + "px";
            Object.assign(videoContainer.style, {
                width: diameter,
                height: diameter,
                borderRadius: "50%",
        ...
        // Create UI elements
        const { video, overlayContainer, ctaElement, loadingIndicator, closeButton, } = this.createVideoEmbedElements(settings);
        ...
        Object.assign(ctaButton.style, {
            ...
            color: (settings === null || settings === void 0 ? void 0 : settings.bookingCtaColor) || "white",
            border: "none",
            borderRadius: "4px",
            fontWeight: "bold",
            cursor: "pointer",
        ...
        videoContainer.addEventListener("click", (e) => {
            ...
            if (e.target === pausePlayButton ||
                pausePlayButton.contains(e.target)) {
                return;
            }
            if (e.target === muteButton || muteButton.contains(e.target)) {
                return;
            }
            ...
            isMuted = false;
            video.play().catch(() => {
                console.warn("meetergo: Couldn't play video with sound due to browser restrictions");
            });
            // Reset pause state
            isVideoPaused = false;
        ...
        this.addAccessibilitySupport(videoContainer, closeButton, ctaButton, bookingLink, pausePlayButton, muteButton);
     ...
     */
    createVideoEmbedElements(settings) {
        ...
        ctaElement.textContent = (settings === null || settings === void 0 ? void 0 : settings.videoCta) || "Click to watch";
        ...
        if (settings === null || settings === void 0 ? void 0 : settings.posterImage) {
     ...
     */
    setPositionStyles(container, position, offset = "16px") {
     ...
     */
    setupVideoSource(video, videoSrc, posterImage, loadingIndicator) {
    ...
    setupHlsVideo(videoElement, videoSrc, posterUrl, container) {
    ...
    initHlsPlayer(video, videoSrc, posterImage, loadingIndicator) {
        if (window.Hls && window.Hls.isSupported()) {
    ...
    fallbackToPoster(video, posterImage) {
     ...
     */
    applyHoverEffects(videoContainer, ctaElement, closeButton) {
        // Scale effect
     ...
     */
    removeHoverEffects(videoContainer, closeButton) {
        if (videoContainer.style.transform.includes("translate")) {
            videoContainer.style.transform = videoContainer.style.transform.replace(/ scale\([\d.]+\)/g, "");
        }
        else {
            videoContainer.style.transform = "";
        }
     ...
     */
    createMinimizedIndicator(videoContainer, buttonColor) {
     ...
     * Add accessibility support
     */
    addAccessibilitySupport(videoContainer, closeButton, ctaButton, bookingLink, pausePlayButton, muteButton) {
     ...
     */
    addVideoLoadingTimeout(video, posterImage, loadingIndicator) {
        setTimeout(() => {
            if (video.readyState === 0 && video.error === null) {
                console.warn("meetergo: Video failed to load after timeout, using poster image");
                this.fallbackToPoster(video, posterImage);
                loadingIndicator.style.display = "none";
            }
        }, 3000);
